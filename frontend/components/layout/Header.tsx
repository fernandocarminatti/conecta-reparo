        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden md:block">
            ...
            <input
              type="text"
              placeholder="Buscar..."
              className="w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 placeholder-gray-400"
            />
          </div>
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                <div className="px-4 py-2 border-b border-gray-100">
                  ...
                  <p className="text-xs text-gray-500">admin@conecta.com</p>
                </div>
                <a
                  href="/admin/profile"
